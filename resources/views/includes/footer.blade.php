            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse " id="navbarNav">
                    <ul class="navbar-nav  mt-5">
                        ...
                        <li class="nav-item mx-2 ">
                            <a class="nav-link text-light" href="../login/logclientes.html">ZONA
                                CLIENTES</a>
                        </li>
                        <li class="nav-item mx-2 ">
                            <a class="nav-link text-light" href="../login/logventas.html">ZONA
                                VENTAS</a>
                        </li>
                        <li class="nav-item mx-2 ">
                            <a class="nav-link text-light" href="../login/loginsistemas.html">ZONA
                                SISTEMAS</a>
                        </li>
                    </ul>
                </div>
